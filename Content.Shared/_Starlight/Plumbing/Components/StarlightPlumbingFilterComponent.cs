...
public sealed partial class StarlightPlumbingFilterComponent : Component // Hardlight: Goob also has a PlumbingFilterComponent which causes RT to throw up if both has the same name
{
